...
<head>
<meta charset="utf-8">
<title>Jobs Connect / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+251) 123-456-789</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Jobs Connect<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Sed ut perspiciaatis unde omnis iste natus error sit<br>
           .</address>
          <p>
            <i class="icon-phone"></i> (+251) 123-456-789 <br>
            <i class="icon-envelope-alt"></i> contact@jobsconnect.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Jobs Connect 2022 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
